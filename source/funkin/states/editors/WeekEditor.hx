...
class WeekEditor extends MusicBeatState
{
	...
	function addEditorBox() {
		...
		var freeplayButton:FlxButton = new FlxButton(0, 650, "Freeplay", function() {
			MusicBeatState.switchState(new WeekEditorFreeplay(weekFile));
...
class WeekEditorFreeplay extends MusicBeatState
{
	var weekFile:WeekFile = null;
	public function new(weekFile:WeekFile = null)
	{
	...
	function addEditorBox() {
		...
		var storyModeButton:FlxButton = new FlxButton(0, 685, "Story Mode", function() {
			MusicBeatState.switchState(new WeekEditor(weekFile));
	...
	override function update(elapsed:Float) {
		if(WeekEditorState.loadedWeek != null) {
			...
			MusicBeatState.switchState(new WeekEditorFreeplay(WeekEditor.loadedWeek));
			WeekEditor.loadedWeek = null;
			return;
		}
